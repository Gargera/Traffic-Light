...
/*
	...
	Function Returns     : void
	Function Arguments   : unsigned char portname,unsigned char value,unsigned char pinnumber
	Function Description : write the value to 4 of port pins starts from pinnumber.
*/
